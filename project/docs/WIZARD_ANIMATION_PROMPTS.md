...
## ?? GU�A DE ESTILO - SPELLLOOP (MUY IMPORTANTE)

### Caracter�sticas visuales del estilo Funko Pop/Cartoon:
...
| **Outlines** | Contorno oscuro grueso (2-3px), ~20-25% de p�xeles oscuros |
| **Colores** | Saturados y vibrantes (~85% saturaci�n), paleta limitada |
...
> **Prop�sito:** Establece el dise�o base del personaje. Guarda esta imagen como referencia.
...
| **TOTAL** | **8 prompts** | **8 imágenes** | **26 sprites** |

> **Nota:** Las animaciones Idle se omiten - se usará el primer frame de Walk como pose estática.

## Prioridad de ejecución:

1. 🎨 **#0** → Referencia (obligatorio primero)
2. 🚶 **#1-4** → Walk (16 sprites) - Mayor impacto
3. ✨ **#5** → Cast (4 sprites) - Feedback combate
4. 💥 **#6** → Hit (2 sprites) - Feedback daño
5. 💀 **#7** → Death (4 sprites) - Completitud
...
- TIPO_CUERPO: Atl�tico/equilibrado
- COLOR_PRINCIPAL: #4A7A4A (verde bosque)
- COLOR_ACENTO: #8B4513 (marr�n cuero)

---

## ?? Especificaciones T�cnicas Est�ndar (TODOS los personajes)

| Propiedad | Valor | Notas |
|-----------|-------|-------|
| Tama�o frame | 500x500 px | Contenido centrado |
| Outline | 2-3 px | Color #1A1A2E |
| Proporci�n cabeza | ~30% altura | Estilo Funko/Chibi |
| Saturaci�n colores | 85%+ | Colores vibrantes |
