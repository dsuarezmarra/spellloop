# AudioManager.gd
# Enhanced audio system manager for music, sound effects, and dynamic audio
# Handles audio playback, volume control, biome music, and spell sound effects
#
# Public API:
# - play_music(track_name: String, fade_time: float = 1.0) -> void
# - stop_music(fade_time: float = 1.0) -> void
# - play_sfx(sfx_name: String, volume: float = 1.0, pitch: float = 1.0) -> void
# - play_spell_cast_sfx(spell_id: String) -> void
# - play_biome_music(biome: String) -> void
...
# - music_stopped()
# - volume_changed(bus_name: String, new_volume: float)
...
func play_sfx_enhanced(sfx_name: String, volume: float = 1.0, pitch: float = 1.0) -> void:
...
func play_ambient_sound(ambient_track: String) -> void:
...
func _apply_muffled_effect(duration: float) -> void:
	...
	var current_sfx_volume = sfx_volume
