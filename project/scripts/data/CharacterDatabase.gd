...
const CHARACTERS: Dictionary = {
	...
	"frost_mage": {
		...
		# Base stats (THE STANDARD - all other characters compare to this)
		"stats": {
			"max_health": 100,
			"health_regen": 0.0,
			"move_speed": 50.0,  # STANDARD speed
			"armor": 0,
			"damage_mult": 1.0,
			"cooldown_mult": 1.0,
			"area_mult": 1.0,
	...
	"pyromancer": {
		...
		"stats": {
			"max_health": 90,
			"health_regen": 0.0,
			"move_speed": 52.0,  # Slightly faster
			"armor": 0,
