...
const DEFENSIVE_UPGRADES: Dictionary = {
	...
	"health_1": {
		...
		"icon": "res://assets/icons/icon_heart_health.png",
		"category": "defensive",
		"tier": 1,
		"max_stacks": 10,
	...
	"regen_1": {
		...
		"icon": "res://assets/icons/icon_potion_red.png",
		"category": "defensive",
		"tier": 1,
		"max_stacks": 6,
	...
	"armor_1": {
		...
		"icon": "res://assets/icons/icon_shield_round.png",
		"category": "defensive",
		"tier": 1,
		"max_stacks": 8,
...
const UTILITY_UPGRADES: Dictionary = {
	...
	"xp_1": {
		...
		"icon": "res://assets/icons/icon_scroll_xp.png",
		"category": "utility",
		"tier": 1,
		"max_stacks": 6,
...
const OFFENSIVE_UPGRADES: Dictionary = {
	...
	"damage_1": {
		...
		"icon": "res://assets/icons/icon_sword_steel.png",
		"category": "offensive",
		"tier": 1,
		"max_stacks": 6,
	...
	"cooldown_1": {
		...
		"icon": "res://assets/icons/icon_cooldown.png",
		"category": "offensive",
		"tier": 2,
		"max_stacks": 4,
