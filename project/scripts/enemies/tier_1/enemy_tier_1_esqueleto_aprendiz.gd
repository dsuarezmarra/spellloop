...
class_name EnemyTier1EsqueletoAprendiz
@export var enemy_name = "Esqueleto Aprendiz"
@export var slug = "enemy_tier_1_esqueleto_aprendiz"
@export var difficulty_tier = 1
@export var base_hp = 32
...
@export var sprite_path = "res://assets/sprites/enemies/tier_1/esqueleto_aprendiz.png"
...
func _physics_process(delta):
    if not player_reference:
        return
    # Comportamiento simple: patrulla y persigue
    if global_position.distance_to(player_reference.global_position) < 200 * scale_manager.current_scale:
        seek_player(delta)
