...
class_name EnemyTier1MurcielagoEtereo
@export var enemy_name = "Murciélago Etéreo"
@export var slug = "enemy_tier_1_murcielago_etereo"
...
@export var collider_radius = 20.0
@export var attack_type = "melee"
@export var attack_rate = 1.2
@export var movement_behavior = "flying"
@export var sprite_path = "res://assets/sprites/enemies/tier_1/murcielago_etereo.png"
...
func _physics_process(delta):
    if not player_reference:
        return
    # Vuela alrededor del jugador y ataca desde el aire
