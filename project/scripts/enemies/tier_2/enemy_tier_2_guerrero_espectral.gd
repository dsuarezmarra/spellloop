...
@export var enemy_name = "Guerrero Spectral"
@export var slug = "enemy_tier_2_guerrero_espectral"
@export var difficulty_tier = 2
@export var base_hp = 60
@export var base_speed = 48.0
@export var base_damage = 12
@export var xp_drop = 8
@export var size_px = 72
@export var collider_radius = 32.0
@export var attack_type = "melee"
@export var attack_rate = 1.4
@export var movement_behavior = "aggressive"
@export var sprite_path = "res://assets/sprites/enemies/tier_2/guerrero_espectral.png"
