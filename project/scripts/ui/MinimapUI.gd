...
func update_minimap():
	...
	# If dungeon system disabled or data missing, do nothing early
	if dungeon_data == null or dungeon_data.is_empty():
		print("[MinimapUI] Minimapa desactivado o sin datos")
		return
...
func _on_room_entered(_room_data):
