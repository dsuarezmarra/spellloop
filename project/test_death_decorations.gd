...
# Script de prueba para sistema de bioma Death
# Muestra textura base animada (decoraciones pendientes)

func _ready():
	print("\n=== PRUEBA COMPLETA - SISTEMA BIOMA DEATH ===\n")

	# ===== TEXTURA BASE ANIMADA DEL SUELO (MOSAICO) =====
	print("--- TEXTURA BASE ANIMADA (MOSAICO) ---")
	var base_texture_path = "res://assets/textures/biomes/Death/base/death_base_animated_sheet_f8_1024.png"
