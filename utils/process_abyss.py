#!/usr/bin/env python3
"""
Procesador de sprites para Abyss (Shadow + Void)
Abismo - void maw projectile that consumes everything

Colores clave:
- Core: Absolute void black (#0D0310)
- Inner ring: Very dark purple (#1F1028)
- Outer maw: Dark purple teeth/edges (#38204D)
- Consuming effect: Faint purple-red (#5D2D50)
"""
...
def main():
    ...
    flight_output = os.path.join(base_path, "flight_spritesheet_abyss.png")
    
    impact_input = os.path.join(base_path, "impact.png")
    impact_output = os.path.join(base_path, "impact_spritesheet_abyss.png")
    
    print("=" * 60)
    print("PROCESANDO ABYSS (Shadow + Void)")
    print("Abismo - Void Maw that Consumes")
    print("=" * 60)
