#!/usr/bin/env python3
"""
Procesa los sprites de Firestorm (Fire + Wind) para el juego.
...
def main():
    base_dir = r"c:\git\spellloop\project\assets\sprites\projectiles\fusion\firestorm"
    
    sprites_to_process = [
        ("flight.png", "flight_spritesheet.png"),
        ("impact.png", "impact_spritesheet.png"),
    ]
