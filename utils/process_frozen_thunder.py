#!/usr/bin/env python3
"""
process_frozen_thunder.py
Procesador de sprites para Frozen Thunder (Trueno Congelado)
Ice + Lightning = Relámpago cristalino azul-celeste

Archivos de entrada (desde ChatGPT/DALL-E con fondo removido):
- unnamed-removebg-preview.png: 4 sprites de FLIGHT (rayos horizontales ~328px)
- unnamed-removebg-preview (1).png: 4 sprites de IMPACT (explosiones ~140px)
...
# Carpeta de sprites
SPRITE_FOLDER = Path(r"C:\git\spellloop\project\assets\sprites\projectiles\fusion\frozen_thunder")

# Archivos de entrada
FLIGHT_FILE = "unnamed-removebg-preview.png"
IMPACT_FILE = "unnamed-removebg-preview (1).png"
...
def process_impact():
    ...
    output_path = SPRITE_FOLDER / "impact_spritesheet_frozen_thunder.png"
...
def process_flight():
    ...
    output_path = SPRITE_FOLDER / "flight_spritesheet_frozen_thunder.png"
    spritesheet.save(output_path)
    print(f"  ✅ Guardado: {output_path.name}")
    print(f"     Tamaño: {SPRITESHEET_WIDTH}x{SPRITESHEET_HEIGHT} ({NUM_FRAMES} frames)")
...
def main():
    print("=" * 60)
    print("  PROCESADOR DE SPRITESHEETS - FROZEN THUNDER")
    print("=" * 60)
