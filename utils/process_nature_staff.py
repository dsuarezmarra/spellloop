#!/usr/bin/env python3
"""
Process nature staff sprites - already have transparent background.
...
# Paths
INPUT_DIR = r"C:\git\spellloop\project\assets\sprites\projectiles\nature_staff"
...
def main():
    print("=" * 60)
    print("Nature Staff Sprite Processor")
