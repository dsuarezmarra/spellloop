...
dark_flame, steam_cannon, volcano
"""
...
if __name__ == "__main__":
    ...
    sources = [
        (base / 'dark_flame' / 'unnamed-removebg-preview.png', 'dark_flame', base / 'dark_flame'),
        (base / 'steam_cannon' / 'unnamed-removebg-preview.png', 'steam_cannon', base / 'steam_cannon'),
        (base / 'volcano' / 'unnamed-removebg-preview.png', 'volcano', base / 'volcano'),
    ]
