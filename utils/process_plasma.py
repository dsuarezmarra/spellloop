#!/usr/bin/env python3
"""
Procesador de sprites para Plasma (Fire + Lightning)
=====================================================
Procesa las imágenes de flight e impact generadas por ChatGPT
para crear spritesheets compatibles con el juego.

Los sprites de entrada son grillas de 4 columnas (aprox 600x400px).

Estructura de salida:
- flight_spritesheet_plasma.png (256x64, 4 frames de 64x64)
- impact_spritesheet_plasma.png (256x64, 4 frames de 64x64)
"""
...
def main():
    ...
    if not INPUT_DIR.exists():
        ...
        print(f"\nCrea la carpeta y añade los archivos:")
        print(f"  - flight.png")
        print(f"  - impact.png")
        return
    ...
    configs = [
        ("flight.png", f"flight_spritesheet_{WEAPON_ID}.png", "FLIGHT (rayo de plasma)"),
        ("impact.png", f"impact_spritesheet_{WEAPON_ID}.png", "IMPACT (explosión de plasma)")
    ]
