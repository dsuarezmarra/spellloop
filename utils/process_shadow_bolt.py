#!/usr/bin/env python3
"""
process_shadow_bolt.py
Procesador de sprites para Shadow Bolt (Rayo de Sombra)
Shadow + Lightning = Rayo oscuro etéreo con chispas fantasmales
...
# Carpeta de sprites
SPRITE_FOLDER = r"C:\git\spellloop\project\assets\sprites\projectiles\fusion\shadow_bolt"
...
def main():
    print("=" * 60)
    print("  PROCESADOR DE SPRITESHEETS - SHADOW BOLT")
    print("  🗡️⚡ Rayo de Sombra (Shadow + Lightning)")
    print("=" * 60)
    ...
    for filename in INPUT_FILES:
        ...
        output_filename = f"{base_name}_spritesheet_shadow_bolt.png"
