#!/usr/bin/env python3
"""
Process shadow_dagger sprites - already have transparent background.
...
# Paths
INPUT_DIR = r"C:\git\spellloop\project\assets\sprites\projectiles\weapons\shadow_dagger"
...
def main():
    print("=" * 60)
    print("Shadow Dagger Sprite Processor")
    ...
    if os.path.exists(flight_input):
        ...
        print(f"Warning: {flight_input} not found")
    ...
    if os.path.exists(impact_input):
        ...
        print(f"Warning: {impact_input} not found")
