#!/usr/bin/env python3
"""
Process wind blade sprites - already have transparent background.
...
# Paths
INPUT_DIR = r"C:\git\spellloop\project\assets\sprites\projectiles\wind_blade"
...
def main():
    print("=" * 60)
    print("Wind Blade Sprite Processor")
